...
const double INITIAL_REACTIVE_CONCENTRATION = 500.0;
// First-order depletion rate of the particle-carried reactive concentration [1/s].
const double REACTIVE_CONCENTRATION_DECAY = 5.0E-3;
...
const double REACTIVE_TO_MINERAL_STOICH = 1.0;
...
const double MINERAL_MOLAR_VOLUME = 7.4E-5;
// Unit out-of-plane thickness for the 2D DFN representation [m] (1 m for simplifying).
const double FRACTURE_OUT_OF_PLANE_THICKNESS = 1.0;
