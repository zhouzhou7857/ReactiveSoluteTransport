...
OUTPUT_PNG = OUTPUT_ROOT / "song_selected_10cm_triptych.png"
OUTPUT_PDF = OUTPUT_ROOT / "song_selected_10cm_triptych.pdf"
...
def main():
    ...
    for case_name, _, _ in CASES:
        ...
        data = load_filemode_dfn(path)
        loaded[case_name] = data
