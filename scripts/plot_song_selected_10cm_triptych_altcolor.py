...
OUTPUT_PNG = OUTPUT_ROOT / "song_selected_10cm_triptych_altcolor.png"
OUTPUT_PDF = OUTPUT_ROOT / "song_selected_10cm_triptych_altcolor.pdf"
...
def main():
    ...
    cmap = LinearSegmentedColormap.from_list(
        "teal_gold",
        ["#12343b", "#2d6a73", "#8fb9a8", "#d7c27a", "#b9770e"],
    )
